...
<head>
  ...
  <title>Your Order — <?= e($event['name']) ?></title>
...
<nav class="topnav">
  <div class="topnav-logo">
    <img src="<?= SITE_URL ?>/static/images/logo_white_background.jpg" alt="OmniSpace" style="height:32px;"
         onerror="this.style.display='none'">
  </div>
  <div class="topnav-title"><?= e($event['name']) ?></div>
  <div class="topnav-actions">
    <a href="<?= SITE_URL ?>/<?= e($eventSlug) ?>" style="font-size:13px;">← Back to Catalogue</a>
  </div>
</nav>

<div class="checkout-page">
  <h1 style="font-size:22px;color:#0A9696;margin-bottom:6px;">Review &amp; Submit Your Order</h1>
  <p style="color:#6E6E6E;margin-bottom:24px;"><?= e($event['name']) ?> · <?= e($event['venue']) ?></p>
  ...
  <div id="empty-cart-msg" style="display:none;text-align:center;padding:40px;">
    ...
    <a href="<?= SITE_URL ?>/<?= e($eventSlug) ?>" class="btn btn-primary mt-2">← Back to Catalogue</a>
  </div>
  ...
  <div id="checkout-content" style="display:none;">
    <div class="checkout-grid">
      ...
      <div>
          ...
          <div class="card-body">
            <table class="order-summary-table" id="summary-table">
              ...
              <tfoot class="totals">
                ...
                <tr>
                  <td colspan="3" style="text-align:right;color:#6E6E6E;">VAT (16%)</td>
        ...
        <a href="<?= SITE_URL ?>/<?= e($eventSlug) ?>" class="btn btn-outline btn-sm">← Add More Items</a>
      </div>
          ...
          <div class="card-body">
            ...
            <form id="checkout-form">
              ...
              <div style="background:#D6F0EF;border-radius:6px;padding:12px;font-size:12px;color:#0A9696;margin-bottom:16px;">
                ...
                <a href="https://wa.me/<?= preg_replace('/[^0-9]/', '', $companyWA) ?>">WhatsApp us</a>
              </div>
