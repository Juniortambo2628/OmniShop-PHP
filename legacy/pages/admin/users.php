...
<div class="card mb-2">
  ...
  <div class="card-body">
    <form method="POST" action="<?= SITE_URL ?>/admin/users" style="display:grid;grid-template-columns:1fr 1fr 1fr 140px 140px;gap:12px;align-items:flex-end;">
    ...
    <table class="admin-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <form method="POST" action="<?= SITE_URL ?>/admin/users" style="display:flex;gap:6px;">
